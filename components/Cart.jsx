  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[10002] w-16 h-16 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-200 hover:scale-110 group"
      >
        <svg
          className="w-7 h-7"
          fill="none"
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-[10003] flex items-end justify-center bg-black/60 backdrop-blur-sm animate-fadeIn"
                      ...
                      <div className="flex-1 min-w-0 flex flex-col gap-1">
                        ...
                        <div className="flex items-center justify-between gap-2 flex-wrap">
                          <div className="flex flex-col gap-0.5">
                            ...
                            {/* Mostrar precio base si existe y es diferente al precio actual */}
